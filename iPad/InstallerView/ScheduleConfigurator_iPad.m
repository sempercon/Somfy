...
@interface ScheduleConfigurator_iPad (Private)
...
@implementation ScheduleConfigurator_iPad
@synthesize Logout;
...
@synthesize datePicker,timePicker,TodatePicker,scenesPicker;
@synthesize addScheduleView,editScheduleView;
@synthesize addScheduleTextField,editScheduleTextField;
@synthesize	imgView;
...
{
	[[AppDelegate_iPad sharedAppDelegate]SetInstallerViewIndex:5];
...
{	
	...
	for(int i=0;i<[scheduleArr count];i++)
	{
		...
		RRSGlowLabel *scheduleName = [[RRSGlowLabel alloc] initWithFrame:CGRectMake(x+2, y, 160, 60)];
		...
		scheduleName.glowColor = [UIColor colorWithRed:157/255 green:163/255 blue:167/255 alpha:1.0 ];
		//lbl3.glowColor = [UIColor colorWithRed:1.0 green:0.70 blue:1.0 alpha:1.0];
		scheduleName.glowOffset = CGSizeMake(0.0, 0.0);
		scheduleName.glowAmount = 10.0;
		...
		for(int j=0;j<[selectedSchedulesArray count];j++)
		{
			if(i==[[selectedSchedulesArray objectAtIndex:j] intValue])
			{
				...
				RRSGlowLabel *lbl1 = [[RRSGlowLabel alloc]initWithFrame:CGRectMake(19, 0, 160, 30)];
				lbl1.textColor = [UIColor whiteColor];
				lbl1.backgroundColor = [UIColor clearColor];
				lbl1.textAlignment = UITextAlignmentLeft;
				lbl1.font = [UIFont fontWithName:@"HelveticaNeue" size:17];
				lbl1.text = @"ACTIVATION DAY";
				lbl1.glowColor = [UIColor colorWithRed:157/255 green:163/255 blue:167/255 alpha:1.0 ];
				//lbl3.glowColor = [UIColor colorWithRed:1.0 green:0.70 blue:1.0 alpha:1.0];
				lbl1.glowOffset = CGSizeMake(0.0, 0.0);
				lbl1.glowAmount = 6.0;
				...
				lblWeekorYear.textColor = [UIColor grayColor];
				...
				g_sunBtn = sunBtn;
				//sunBtn.frame = CGRectMake(11, 158, 37, 37);
				...
				g_monBtn = monBtn;
				//monBtn.frame = CGRectMake(95, 158, 37, 37);
				...
				g_tueBtn = tueBtn;
				//tueBtn.frame = CGRectMake(179, 158, 37, 37);
				...
				g_wedBtn = wedBtn;
				//wedBtn.frame = CGRectMake(259, 158, 37, 37);
				...
				g_thuBtn = thuBtn;
				//thuBtn.frame = CGRectMake(11, 212, 37, 37);
				...
				g_friBtn = friBtn;
				//friBtn.frame = CGRectMake(95, 212, 37, 37);
				...
				g_satBtn = satBtn;
				//satBtn.frame = CGRectMake(178, 212, 37, 37);
				...
				//allBtn.frame = CGRectMake(259, 212, 37, 37);
				...
				fromLbl.textColor = [UIColor grayColor];
				...
				toLbl.textColor = [UIColor grayColor];
                ...
                // Hint
                lbl1 = [[RRSGlowLabel alloc]initWithFrame:CGRectMake(19, 277, 160, 35)];
				//lbl1 = [[RRSGlowLabel alloc]initWithFrame:CGRectMake(18, 269, 160, 35)];
				lbl1.textColor = [UIColor whiteColor];
				lbl1.backgroundColor = [UIColor clearColor];
				lbl1.textAlignment = UITextAlignmentLeft;
				lbl1.font = [UIFont fontWithName:@"HelveticaNeue" size:17];
				...
				lblsunrise.textColor = [UIColor grayColor];
				...
				lblsunset.textColor = [UIColor grayColor];
				...
				lblEventSliderValue.textColor = [UIColor grayColor];
				...
				lblSliderValue1.textColor = [UIColor grayColor];
				...
				lblSliderValue2.textColor = [UIColor grayColor];
				...
				lbl1 = [[RRSGlowLabel alloc]initWithFrame:CGRectMake(18, 491, 160, 35)];
				lbl1.textColor = [UIColor whiteColor];
				lbl1.backgroundColor = [UIColor clearColor];
				lbl1.textAlignment = UITextAlignmentLeft;
				lbl1.font = [UIFont fontWithName:@"HelveticaNeue" size:17];
				...
				{
					lbl1 = [[RRSGlowLabel alloc]initWithFrame:CGRectMake(20, 649, 111, 40)];
					lbl1.textColor = [UIColor whiteColor];
					lbl1.backgroundColor = [UIColor clearColor];
					lbl1.textAlignment = UITextAlignmentLeft;
					lbl1.font = [UIFont fontWithName:@"HelveticaNeue" size:17];
				...
				else
				{
					...
					//[activationDaySegment setSelectedSegmentIndex:1];
...
-(void)ScheduleEdit:(id)sender
{
    ...
    {
       /* int Currpos = xposition+340;//TagVal*165;
        LastOffsetPointSchedule = CGPointMake(Currpos,0);*/
		int currentSceneEditWidth = (TagVal * 172) + 172 +((selCount-1) * 340);//142 width of one scene bg + gap
		int curWidth = currentSceneEditWidth - xposition;
		int widthToAdd = (curWidth+340)-840;
...
-(void)ScheduleClose:(id)sender
{
	...
	[self LoadAllSchedules:[AppDelegate_iPad sharedAppDelegate].g_formatScheduleList];
	if(LastOffsetPointSchedule.x < 100 || scheduleScrollView.contentSize.width<840)
	{
...
{
	[[AppDelegate_iPad sharedAppDelegate].ScheduleConfigviewController.view removeFromSuperview];
...
- (void)dealloc {
	...
	[datePicker,timePicker,TodatePicker,scenesPicker release];
	
	[editScheduleView,addScheduleView release];
	[editScheduleTextField,addScheduleTextField release];
